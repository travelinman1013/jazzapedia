...
*Sources: [Source1](https://www.indigits.net/music/hypnotic-brass-ensemble/), [Source2](https://www.last.fm/music/Hypnotic+Brass+Ensemble/+wiki), [Source3](https://www.thetrumpetblog.com/hypnotic-brass-ensemble/), [Source4](https://www.ronniescotts.co.uk/find-a-show/hypnotic-brass-ensemble), [Source5](https://www.hayfestival.com/p-2678-hypnotic-brass-ensemble.aspx?skinid=16), [Source6](https://gorillaz.fandom.com/wiki/Hypnotic_Brass_Ensemble)*
...
## Members
- [[christopher_anderson|Christopher Anderson]] - drums (drum set)
- [[hashim_bunch|Hashim Bunch]] - bass
- [[tycho_cohran|Tycho Cohran]]
- [[jafar_graves|Jafar Graves]]
- [[saiph_graves|Saiph Graves]]
- [[seba_graves|Seba Graves]]
- [[tarik_graves|Tarik Graves]]
- [[amal_hubert|Amal Hubert]]
- [[gabriel_hubert|Gabriel Hubert]]
- [[uttama_hubert|Uttama Hubert]]
- [[kevin_hunt|Kevin Hunt]] - electric guitar

## Musical Connections

### Mentors/Influences
- [[kelan_phil_cohran|Kelan Phil Cohran]] - Father and primary musical mentor who taught all brothers to play instruments and established the Sun Ark as a creative space; influenced their approach to music, self-expression, and cosmic music philosophy (Phil Cohran Youth Ensemble, Circle of Sound, composition 'Alyo' (featured on HBE album)) [1980s-present (childhood through adulthood)]
- [[sun_ra|Sun Ra]] - Indirect but profound influence through father Phil Cohran's seminal role with Sun Ra's Arkestra in the 1950s; shaped the family's approach to experimental and cosmic music (Sun Ra Arkestra) [1950s (father's era, inherited influence)]
- [[earth_wind_and_fire|Earth, Wind & Fire]] - Creative influence on their father Phil Cohran's musical direction and input, which was passed down to the brothers (General stylistic influence) [Inherited influence]

### Key Collaborators
- [[mos_def|Mos Def]] - Early career collaborator who helped gain them initial recognition and industry credibility (Live performances and gigs) [Late 1990s-early 2000s]
- [[erykah_badu|Erykah Badu]] - Early career collaborator whose association helped establish their independent standing (Live performances and gigs) [Late 1990s-early 2000s]
- [[gorillaz|Gorillaz]] - Major collaborative partnership resulting in album contributions (Gorillaz album (final/recent album at time of source publication)) [2000s-2010s]
- [[tony_allen|Tony Allen]] - Drummer whose association with the group marked a significant turning point in their development and artistic direction (Collaborative performances and recordings) [2000s onward]

### Artists Influenced
- [[contemporary_brass_bands_and_street_musicians|Contemporary brass bands and street musicians]] - Established innovative approach to blending jazz and hip-hop with brass instruments, inspiring similar ensembles (General stylistic influence on brass band genre) [2000s-present]
