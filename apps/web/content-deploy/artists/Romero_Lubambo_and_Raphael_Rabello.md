...
audio_profile:
  ...
  instrumentalness_avg: 0.642
  loudness_avg: -14.8
  speechiness_avg: 0.044
  liveness_avg: 0.197
  track_count: 64
  computed_at: '2025-12-23T08:16:03.740877'
similar_artists: []
musical_connections:
  collaborators:
    - Duduka da Fonseca
...
- **Born**: 1962-10-31 in Petrópolis
- **Died**: 1995-04-27
- **Occupation**: composer, guitarist
- **Instruments**: guitar
- **Years Active**: 1974–1995
- **Record Labels**: PolyGram, RCA Records
...
*Sources: [Source1](https://musicabrasileira.org/raphael-rabello-cry-my-guitar/)*

*Source: [Wikipedia](https://en.wikipedia.org/wiki/Raphael_Rabello)*
...
### Top Tracks
1. Terra do Nunca (Quase Memória)
2. Folhas Secas (Autonomia)
3. De Conversa em Conversa (Autonomia)
4. Doce de coco (Appassionato)
5. De Frente pro Crime (Autonomia)
6. Influência do Jazz (Lua do Arpoador)
7. My Favorite Things (Songs of Joy & Peace)
8. Daily Rose
9. Brasileirinho
10. Complicity (Encyclopedia of Arto)

## External Links
- [Spotify](https://open.spotify.com/artist/2tfVfgslNHoisjzLLgnRIV)
- [Wikipedia](https://en.wikipedia.org/wiki/Raphael_Rabello)
