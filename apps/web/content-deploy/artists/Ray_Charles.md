...
audio_profile:
  ...
  liveness_avg: 0.192
  track_count: 81
  computed_at: '2025-12-23T08:16:03.655815'
similar_artists: []
musical_connections:
  collaborators:
    - Quincy Jones
...
## Quick Info
- **Genres**: jazz blues, soul, soul blues, blues, classic soul
- **Birth Name**: Raymond Charles Robinson
- **Also Known As**: Ray Charles, The Genius
- **Born**: 1930-09-23 in Albany
- **Died**: 2004-06-10
- **Occupation**: pianist, composer, singer-songwriter
- **Instruments**: piano, voice
- **Years Active**: 1945–2004
- **Record Labels**: Swing Time, ABC Records, Atlantic Records, Warner Bros. Records, Philips Records
...
*Sources: [Source1](Wikipedia), [Source2](Ray Charles Official Website), [Source3](New Georgia Encyclopedia), [Source4](Florida Division of Arts and Culture), [Source5](HistoryLink.org)*

*Source: [Wikipedia](https://en.wikipedia.org/wiki/Ray_Charles)*
