...
audio_profile:
  ...
  instrumentalness_avg: 0.816
  loudness_avg: -17.3
  speechiness_avg: 0.057
  liveness_avg: 0.1
  track_count: 10
  computed_at: '2025-12-23T08:16:01.640682'
similar_artists: []
musical_connections:
  collaborators:
    - Jacob Sacks
...
*Sources: [Source1](http://firehouse12.com/jazz-series/2023/8/21/dan-weiss), [Source2](https://www.allaboutjazz.com/musicians/dan-weiss/), [Source3](https://www.mymusicmasterclass.com/artist/artists/dan-weiss/), [Source4](https://www.arsnovaworkshop.org/programs/dan-weiss-trio/), [Source5](https://www.allaboutjazz.com/dan-weiss-the-creative-absence-of-egotism-dan-weiss-by-lloyd-n-peterson-jr)*

*Source: [Wikipedia](https://en.wikipedia.org/wiki/Dan_Weiss_(drummer))*

### Top Tracks
1. For Samirji (Now Yes When)
2. Not Yet (Now Yes When)
3. Richard Dawson (Now Yes When)
4. Wizards (Now Yes When)
5. Chakradar 1 (Now Yes When)
6. The Day After Tomorrow (Now Yes When)
7. Granollers Slayer (Now Yes When)
8. Ode to Meshuggah (Now Yes When)
9. Chakradar 2 (Now Yes When)
10. Chakradar 3 (Now Yes When)

## Discography

### Top Tracks
1. For Samirji (Now Yes When)
2. Chakradar 1 (Now Yes When)
3. Not Yet (Now Yes When)
4. Wizards (Now Yes When)
5. The Day After Tomorrow (Now Yes When)
6. Chakradar 2 (Now Yes When)
7. Richard Dawson (Now Yes When)
8. Granollers Slayer (Now Yes When)
9. Ode to Meshuggah (Now Yes When)
10. Chakradar 3 (Now Yes When)

## External Links
- [Spotify](https://open.spotify.com/artist/30cq7trXBYEc1OycJYtS7m)
- [Wikipedia](https://en.wikipedia.org/wiki/Dan_Weiss_(drummer))
