---
title: Maria Luiza Jobim
wiki_slug: maria-luiza-jobim
schema_version: 2
status: deceased
...
audio_profile:
  ...
  liveness_avg: 0.143
  track_count: 46
  computed_at: '2025-12-23T08:16:03.175813'
similar_artists: []
musical_connections:
  collaborators:
    - Daniel Jobim
...
- **Born**: 1927-01-25 in Rio de Janeiro
- **Died**: 1994-12-08
...
*Sources: [Source1](https://www.jncquoi.com/en/whats-on/private/maria-luiza-jobim-concert/1691/), [Source2](https://www.youtube.com/watch?v=hCirQ4jFOSg)*

*Source: [Wikipedia](https://en.wikipedia.org/wiki/Ant%C3%B4nio_Carlos_Jobim)*
...
2. Farol (Farol)
3. GO GO GO (GO GO GO)
4. Insensatez (Insensatez)
5. Samba De Maria Luiza (feat. Maria Luiza Jobim) (Antonio Brasileiro)
6. O Culpado é o Cupido (Azul)
7. Boca de Açaí (Azul)
8. Tiramisù (Tiramisù)
9. Boca de Açaí (Boca de Açaí)
10. Forever Green (feat. Maria Luiza Jobim) (Antonio Brasileiro)
