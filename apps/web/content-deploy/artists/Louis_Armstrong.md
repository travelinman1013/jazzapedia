...
audio_profile:
  ...
  liveness_avg: 0.234
  track_count: 183
  computed_at: '2025-12-23T08:14:23.185421'
similar_artists: []
musical_connections:
  collaborators:
...
## Quick Info
- **Genres**: jazz, swing music, big band, vocal jazz, jazz blues
- **Birth Name**: Louis Daniel Armstrong
- **Also Known As**: Satchmo, Satch, Pops
- **Born**: 1901-08-04 in New Orleans
- **Died**: 1971-07-06
- **Occupation**: actor, street artist, trumpeter
- **Instruments**: trumpet, cornet, voice
- **Years Active**: 1918–1971
- **Record Labels**: ABC Records, Audio Fidelity, Columbia Records, Decca
- **Spouse**: Lucille Armstrong, Lil Hardin Armstrong
- **Associated Acts**: Ella Fitzgerald & Louis Armstrong
...
- [[EARL_HINES_AND_HIS_ORCHESTRA]] - Pianist who accompanied Armstrong on revolutionary recordings (West End Blues, Weather Bird) [1928]
...
*Sources: [Source1](Wikipedia), [Source2](Britannica), [Source3](KGU Music), [Source4](National Archives)*

*Source: [Wikipedia](https://en.wikipedia.org/wiki/Louis_Armstrong)*
