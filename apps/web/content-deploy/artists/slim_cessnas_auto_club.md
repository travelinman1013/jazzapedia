...
audio_profile:
  ...
  liveness_avg: 0.211
  track_count: 50
  computed_at: '2025-12-23T08:16:15.739865'
similar_artists: []
musical_connections:
  collaborators:
    - Munly Munly
...
## Quick Info
- **Genres**: southern gothic, alt country, americana, anti-folk
...
*Sources: [Source1](https://www.westword.com/music/the-gospel-of-denver-band-slim-cessnas-auto-club-18519313/), [Source2](https://narcmagazine.com/slim-cessnas-auto-club/), [Source3](https://www.lonesomehighway.com/interviewsold/2017/10/3/slim-cessna-interview.html), [Source4](https://www.thepunksite.com/interviews/slim-cessnas-auto-club/), [Source5](https://thestrangebrew.co.uk/slim-cessnas-auto-club/)*
...
### Mentors/Influences
- [[traditional_country_and_folk_musicians|Traditional Country and Folk Musicians]] - Slim Cessna grew up listening to and playing traditional country and folk music, which deeply influenced his songwriting and the band's early direction. (General influence across all albums) [Childhood through present]

### Key Collaborators
- [[munly_munly|Munly Munly]] - Long-time band member, co-songwriter, and creative partner; also collaborates with Cessna in side projects like DBUK. (All major SCAC albums, DBUK) [Early 2000s–present]
- [[lord_dwight_pentacost|Lord Dwight Pentacost]] - Core band member since the early 2000s, contributing guitar and songwriting. (All major SCAC albums) [Early 2000s–present]
- [[rebecca_vera|Rebecca Vera]] - Band member and Munly’s partner, contributing vocals and instrumentation; also part of DBUK. (Recent SCAC albums, DBUK) [2010s–present]
- [[george_cessna|George Cessna]] - Slim’s son and bassist, joined as a full-time member in 2018. (Recent SCAC albums) [2018–present]
- [[wayfarer|Wayfarer]] - Collaborated with SCAC members Munly and George on Wayfarer’s black metal album. (Wayfarer’s latest record) [2020s]

### Artists Influenced
- [[wayfarer|Wayfarer]] - Denver black metal band influenced by SCAC’s gothic Americana style; collaborated with SCAC members. (Wayfarer’s latest record) [2020s]
- [[denver_music_scene_artists|Denver music scene artists]] - Numerous local musicians cite SCAC as a foundational influence in the development of the 'Denver Sound' and alternative Americana. (Various) [1990s–present]
...
### Top Tracks
1. This Is How We Do Things In The Country (The Bloudy Tenent Truth Peace)
2. Last Song About Satan (Always Say Please And Thank You)
3. All About The Bullfrog In Three Verses (Cipher)
4. Cranston (Buried Behind The Barn)
5. Pine Box (Always Say Please And Thank You)
6. This Land Is Our Land Redux (Cipher)
7. Children Of The Lord (Cipher)
8. A Smashing Indictment Of Character (Unentitled)
9. Goddamn Blue Yodel #7 (Always Say Please And Thank You)
10. Magalina Hagalina Boom Boom (Cipher)
