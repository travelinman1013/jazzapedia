---
title: Joe Loss & His Orchestra
wiki_slug: joe-loss-his-orchestra
schema_version: 2
status: deceased
...
audio_profile:
  ...
  instrumentalness_avg: 0.401
  loudness_avg: -14.5
  speechiness_avg: 0.042
  liveness_avg: 0.172
  track_count: 50
  computed_at: '2025-12-23T08:16:02.350458'
similar_artists: []
musical_connections:
  collaborators:
    - The Merry Macs
...
biography_enhanced_at: '2025-09-30T11:34:16.026497'
...
- **Also Known As**: Paul Weston, Jonathan Edwards, the Father of Mood Music
- **Born**: 1912-03-12 in Springfield
- **Died**: 1996-09-20
- **Occupation**: musician, conductor, pianist
- **Instruments**: piano
- **Years Active**: 1933–1970s
- **Record Labels**: Capitol Records, Columbia Records
- **Spouse**: Jo Stafford
...
*Sources: [Source1](encyclopedia.com), [Source2](jazzstandards.com), [Source3](infomotions.com)*

*Source: [Wikipedia](https://en.wikipedia.org/wiki/Paul_Weston)*
...
### Top Tracks
1. Till The Lights Of London Shine Again (Memories)
2. I'll Never Smile Again (Memories)
3. Wheels (Cha Cha)
4. Till the Lights of London Shine Again
5. Behind the Clouds
6. Fascination Waltz (In A Romantic Mood)
7. Somewhere In France With You (Memories)
8. Russian Rose
9. In the Mood (Joe Loss Plays Glenn Miller)
10. Tango D'Amore (World Championship Ballroom Dances)

## External Links
- [Spotify](https://open.spotify.com/artist/3OixquvLvKBdSUJlYDPbxU)
- [Wikipedia](https://en.wikipedia.org/wiki/Paul_Weston)
