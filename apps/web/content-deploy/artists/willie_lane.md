...
audio_profile:
  ...
  liveness_avg: 0.192
  track_count: 50
  computed_at: '2025-12-23T08:16:18.195512'
similar_artists: []
musical_connections:
  collaborators:
    - MV & EE
...
- **Followers**: 64,248
- **Born**: Athol, Massachusetts, USA

## Biography
Willie Lane is a guitarist from New England, known for his work in the psych scene. His early career involved collaborations with experimental units, and he was based in Philadelphia before moving to Western Massachusetts. Lane's music often blends elements of American Primitive and psychedelic styles, creating a unique sound that is both abstract and melodic. His albums, such as 'Known Quantity' and 'Guitar Army of One,' showcase his ability to layer complex sounds, often giving the impression of playing duets with himself. Lane has been associated with the New England psych scene, working alongside artists like MV & EE and Stella Kola.

*Enhanced with Perplexity AI research*

*Sources: [Source1](Forced Exposure), [Source2](AllMusic), [Source3](Raven Sings The Blues)*

## Fun Facts
- Willie Lane is known for his eclectic style, blending folk, blues, and psychedelic elements.
- He has been part of the Fishtown scene in Philadelphia, which influenced his early work.
- Lane's music often references classic American Primitive guitarists like John Fahey.

## Musical Connections

### Mentors/Influences
- [[matt_valentine|Matt Valentine]] - Mentor and collaborator in the New England psych scene (MV & EE projects) [Early 2000s]

### Key Collaborators
- [[mv_and_ee|MV & EE]] - Collaboration in the psych scene (Various MV & EE projects) [Early 2000s]
- [[stella_kola|Stella Kola]] - Collaboration in the New England psych scene (Stella Kola projects) [Early 2000s]
- [[wednesday_knudsen|Wednesday Knudsen]] - Perennial collaborator (Various projects) [Ongoing]
