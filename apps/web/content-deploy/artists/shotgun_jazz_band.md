...
audio_profile:
  ...
  liveness_avg: 0.132
  track_count: 50
  computed_at: '2025-12-23T08:16:15.606483'
similar_artists: []
musical_connections:
  collaborators:
    - John Dixon
...
*Sources: [Source1](https://syncopatedtimes.com/marla-dixon/), [Source2](https://www.shotgunjazzband.com/the-shotgun-jazz-band-moves-on-up), [Source3](http://playing-traditional-jazz.blogspot.com/2015/05/traditional-jazz-meeting-shotgun-jazz.html), [Source4](https://www.neworleans.com/listing/shotgun-jazz-band/46544/), [Source5](https://www.shotgunjazzband.com), [Source6](https://www.offbeat.com/music/shotgun-jazz-band-steppin-gas-independent/), [Source7](https://doorcountypulse.com/bringing-new-orleans-sound-to-door-county/)*
...
### Mentors/Influences
- [[orange_kellin|Orange Kellin]] - Veteran New Orleans jazz clarinetist who played with the band and provided stylistic guidance during their early club performances. (Live performances and club gigs) [2011–2013]

### Key Collaborators
- [[john_dixon|John Dixon]] - Co-founder, banjoist, and band organizer; central to the band's development and sound. (All Shotgun Jazz Band albums and performances) [2011–present]
- [[ben_polcer|Ben Polcer]] - Pianist featured on early recordings and live performances. (Algiers Strut album) [2011–2013]
- [[james_evans|James Evans]] - Clarinet and saxophone player from Wales, regular band member. (Live performances, multiple albums) [2013–present]
- [[tyler_thomson|Tyler Thomson]] - Bassist from Toronto, regular band member. (Live performances, multiple albums) [2013–present]
- [[charlie_halloran|Charlie Halloran]] - Trombonist from St. Louis, regular band member. (Live performances, multiple albums) [2013–present]
- [[justin_peake|Justin Peake]] - Drummer from Alabama, regular band member. (Live performances, multiple albums) [2013–present]

### Artists Influenced
- [[shake_em_up_jazz_band|Shake 'Em Up Jazz Band]] - Inspired by Marla Dixon’s leadership and musicianship, several members of Shotgun Jazz Band joined or collaborated with this all-female ensemble. (Festival performances, collaborative projects) [2016–present]
...
### Top Tracks
1. Creole Song (C'est L'autre Cancan) (Don't Give Up the Ship)
2. All the Whores (Don't Give Up the Ship)
3. I Believe I Can Make It By Myself (Yearning)
4. Old Man Mose (Don't Give Up the Ship)
5. Weed Smoker's Dream (Don't Give Up the Ship)
6. Nobody Knows You When You're Down and Out (Don't Give Up the Ship)
7. White Ghost Shivers (Steppin' on the Gas)
8. Down by the Riverside (Steppin' on the Gas)
9. You Always Hurt the One You Love (Yearning)
10. Over in the Glory Land (Yearning)
