...
## Quick Info
- **Genres**: experimental jazz, nu jazz, jazz funk, jazz, indie jazz
- **Instruments**: tuba
...
*Sources: [Source1](https://chicagopresents.uchicago.edu/people/theon-cross-tuba), [Source2](https://lewishammusic.org/theon-cross/), [Source3](https://ebbmusic.eu/artists/theon-cross/), [Source4](https://kexp.org/read/2022/3/14/midnight-perfect-world-theon-cross/), [Source5](https://daily.bandcamp.com/features/theon-cross-intra-i-interview), [Source6](https://postgenre.org/theon-cross-affirmations-blue-note/), [Source7](https://www.winterjazzfest.com/artist-theon-cross), [Source8](https://www.loudandquiet.com/interview/theon-cross-a-different-kind-of-tuba-player/)*
...
## Associated Acts
- [[seed_ensemble|SEED Ensemble]] - tuba

## Musical Connections

### Mentors/Influences
- [[tomorrows_warriors|Tomorrow's Warriors]] - Alumnus of the legendary jazz ensemble that provided early training and exposure (Jazz workshops and jam nights) [Early career, pre-2013]
- [[lewisham_music|Lewisham Music]] - Started musical training at a young age (Instrumental lessons and development) [Childhood, age 8 onward]
- [[guildhall_school_of_music|Guildhall School of Music]] - Graduated with degree in intensive technical and theoretical study (Formal music education) [Adolescence to early adulthood]

### Key Collaborators
- [[sons_of_kemet|Sons Of Kemet]] - Core member since joining band led by Shabaka Hutchings (Multiple albums including *Your Queen Is A Reptile* (Mercury Prize nominee), global tours) [2013-present]
- [[nubya_garcia|Nubya Garcia]] - Regular collaborator in London jazz scene; contributed to solo work (*Fyah* album; various projects) [2010s-present]
- [[moses_boyd|Moses Boyd]] - Frequent collaborator; conversation inspired *Intra-I* (*Fyah*, *Intra-I*, Moses Boyd Exodus) [2010s-present]
- [[stormzy|Stormzy]] - Worked with grime megastar beyond jazz (Opening track on *Heavy Is The Head*) [2019]
- [[cassie_kinoshis_seed_ensemble|Cassie Kinoshi’s SEED Ensemble]] - Regular player in ensemble (Various award-nominated projects) [2010s-present]
