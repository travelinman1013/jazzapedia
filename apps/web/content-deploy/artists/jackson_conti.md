...
audio_profile:
  ...
  liveness_avg: 0.207
  track_count: 50
  computed_at: '2025-12-23T08:16:10.078998'
similar_artists: []
musical_connections:
  collaborators:
...
- **Followers**: 2,538
- **Origin**: Project formed between Los Angeles, California, United States (Madlib’s base) and Brazil (Ivan Conti’s base in Rio de Janeiro region)
...
*Sources: [Source1](AllMusic artist entry for Jackson Conti (project overview and naming origin).[5]), [Source2](Jazz Is Dead biography of Azymuth (context for Ivan Conti’s role in Brazilian jazz and mention of his collaboration with Madlib as Jackson Conti).[2]), [Source3](Plug One review of *Sujinho* (details on repertoire, style, and specific tracks and guests).[3]), [Source4](RapReviews article on *Sujinho* (discussion of the Jackson Conti name as a Madlib pseudonym and characterization of the collaboration).[7]), [Source5](Wikipedia entry for Ivan Conti (background on his career and status as a Brazilian drummer and composer).[1])*
