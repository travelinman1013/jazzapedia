...
audio_profile:
  ...
  instrumentalness_avg: 0.24
  loudness_avg: -10.6
  speechiness_avg: 0.044
  liveness_avg: 0.239
  track_count: 27
  computed_at: '2025-12-23T08:16:08.546912'
similar_artists: []
musical_connections:
  collaborators: []
  influenced: []
...
## Quick Info
- **Genres**: stoner rock, space rock, stoner metal
...
*Sources: [Source1](YouTube – Evil Chicken official channel About page[1]), [Source2](YouTube – Evil Chicken channel main page[3]), [Source3](YouTube – “Born to Be High (Official Lyric Video)”[4]), [Source4](YouTube Shorts – “Born to Be High | Stoner Rock Vibes for the 4th of July”[2])*
...
### Top Tracks
1. Bill a Bong (Bill a Bong)
2. Lighters Gnomes (Lighters Gnomes)
3. Born To Be High (Born To Be High)
4. Northern Lights (Northern Lights)
5. White Rhino (White Rhino)
6. Smoke Signals (Scrambled)
7. Gas Station Prophet (Scrambled)
8. Southern Stoner Spell (Scrambled)
9. The Cat Left Again, So I Got a Dog (Scrambled)
10. The Meanest Monkey (Мunkii) (Scrambled)
