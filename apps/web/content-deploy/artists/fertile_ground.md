...
audio_profile:
  ...
  liveness_avg: 0.146
  track_count: 50
  computed_at: '2025-12-23T08:16:08.629438'
similar_artists: []
musical_connections:
  collaborators:
    - Navasha Daya
...
## Quick Info
- **Genres**: acid jazz, neo soul, nu jazz
...
*Sources: [Source1](Soulwalking.co.uk), [Source2](JazzSkool.org Fandom), [Source3](YouTube Music), [Source4](MusicBrainz), [Source5](Last.fm)*
...
## Members
- [[navasha_daya|Navasha Daya]]

## Musical Connections

### Key Collaborators
- [[navasha_daya|Navasha Daya]] - Vocalist and core member of Fertile Ground (Fertile Ground albums and recordings) [1997-present]
- [[marcus_asante|Marcus Asante]] - Drummer and core member of Fertile Ground (Fertile Ground albums and recordings) [1997-present]
...
### Top Tracks
1. Black Sunshine (Field Songs Revisited)
2. Take Me Higher (Seasons Change)
3. Yellow Daisies (Black Is....)
4. You (Black Is....)
5. Sentimental Groove (Field Songs Revisited)
6. Let the Wind Blow (Spiritual War (2000))
7. Live in the Light (Black Is....)
8. Broken Branches (Spiritual War (2000))
9. Freedom (Seasons Change)
10. Simple Timeless (Simple Timeless)
