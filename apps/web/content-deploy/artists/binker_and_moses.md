---
title: Binker & Moses
wiki_slug: binker-moses
schema_version: 2
status: active
genres: []
infobox:
  image: 03_Resources/source_material/ArtistPortraits/binker_and_moses.jpg
  caption: Binker & Moses
...
audio_profile:
  ...
  acousticness_avg: 0.002
  instrumentalness_avg: 0.805
  loudness_avg: -11.1
  speechiness_avg: 0.046
  liveness_avg: 0.084
  track_count: 1
  computed_at: '2025-12-23T08:16:05.631584'
similar_artists: []
musical_connections:
  collaborators:
    - Zara McFarlane
...
*Sources: [Source1](General biographical and discography details from major music databases and label/press materials), [Source2](Features and interviews in reputable jazz and music publications discussing Binker & Moses’ role in the UK jazz scene)*
...
### Key Collaborators
- [[zara_mcfarlane|Zara McFarlane]] - Both Binker Golding and Moses Boyd toured as members of Zara McFarlane’s band, where they first solidified their musical rapport before forming Binker & Moses as a standalone duo. (Touring and live performances with Zara McFarlane’s ensemble) [Early–mid 2010s]
- [[evan_parker|Evan Parker]] - Legendary UK free-jazz saxophonist who guested with Binker & Moses, contributing to their move toward more expansive and free-form ensemble pieces. (Guest appearances on the album “Journey to the Mountain of Forever” and the live album “Alive in the East”) [Late 2010s]
- [[byron_wallen|Byron Wallen]] - Trumpeter who joined Binker & Moses on expanded ensemble recordings, helping to deepen the group’s spiritual and modal jazz dimensions. (Guest appearances on “Journey to the Mountain of Forever” and “Alive in the East”) [Late 2010s]
- [[tori_handsley|Tori Handsley]] - Harpist whose contributions brought an ethereal, textural layer to the duo’s extended works. (Guest appearances on “Journey to the Mountain of Forever” and “Alive in the East”) [Late 2010s]
- [[yussef_dayes|Yussef Dayes]] - Drummer who appeared alongside them in expanded live and studio contexts, reinforcing the connection between different strands of the London jazz scene. (Guest on “Journey to the Mountain of Forever” and “Alive in the East”) [Late 2010s]
- [[max_luthert|Max Luthert]] - Electronic musician and bassist who joined the duo to incorporate modular synths, tape loops, and processed sound into their music. (Key collaborator on the album “Feeding the Machine”) [Around 2021–2022]
- [[village_of_the_sun_with_simon_ratcliffe|Village of the Sun (with Simon Ratcliffe)]] - Collaborative project blending the duo’s improvisational jazz energy with electronic and production work from Simon Ratcliffe of Basement Jaxx. (Non-album singles such as “Village of the Sun” and “Ted” credited to Village of the Sun featuring Binker & Moses and Simon Ratcliffe) [Around 2020]
