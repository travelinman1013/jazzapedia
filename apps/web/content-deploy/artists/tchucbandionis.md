---
title: Tchucbandionis
wiki_slug: tchucbandionis
schema_version: 2
status: active
genres: []
infobox:
  image: 03_Resources/source_material/ArtistPortraits/tchucbandionis.jpg
  caption: Tchucbandionis
...
audio_profile:
  ...
  liveness_avg: 0.25
  track_count: 33
  computed_at: '2025-12-23T08:16:16.402880'
similar_artists: []
musical_connections:
  collaborators: []
  influenced: []
...
*Sources: [Source1](Popload article mentioning a São Paulo musician who previously played drums in TchucbandioniS.[1]), [Source2](YouTube/Orchard Enterprises listing for “Capoeira Jaz” by TchucbandioniS from the album *O Novo Transmissor* (2002) via Tratore/Reco‑Head.[3]), [Source3](Brazilian blog post that references Tchucbandionis in the context of Brazilian indie/alternative bands such as Ultraman.[4])*
...
### Top Tracks
1. Madrugão (O Novo Transmissor)
2. Tchucbandionis (O Novo Transmissor)
3. Robot Lover (O Novo Transmissor)
4. Caveira (O Novo Transmissor)
5. Vinil Eletronico (O Novo Transmissor)
6. Um Dolar Furado (O Novo Transmissor)
7. Recruta Zero (O Novo Transmissor)
8. Super 8 (O Novo Transmissor)
9. Debaixo da Ponte (O Novo Transmissor)
10. Desdobrando o Labirinto (O Novo Transmissor)
