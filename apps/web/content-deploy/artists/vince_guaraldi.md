...
audio_profile:
  ...
  instrumentalness_avg: 0.664
  loudness_avg: -16.1
  speechiness_avg: 0.048
  liveness_avg: 0.14
  track_count: 77
  computed_at: '2025-12-23T08:16:17.903672'
similar_artists: []
musical_connections:
  collaborators:
    - Cal Tjader
...
## Quick Info
- **Genres**: christmas
- **Instruments**: original, piano, electric piano
- **Spotify Popularity**: 60/100
- **Followers**: 87,037
- **Born**: 1928-07-17, San Francisco
- **Died**: 1976-02-06
...
*Sources: [Source1](https://pianowithjonny.com/piano-lessons/vince-guaraldi-jazz-genius-behind-the-peanuts-show/), [Source2](http://fivecentsplease.org/dpb/pccbio.html), [Source3](https://orderisda.org/culture/music/jazz-innovator-vince-guaraldi-hit-all-the-right-notes/), [Source4](https://www.openculture.com/2023/12/an-introduction-to-vince-guaraldi-the-jazz-composer-who-created-the-best-christmas-album-ever-a-charlie-brown-christmas.html)*
...
## Associated Acts
- [[vince_guaraldi_trio|Vince Guaraldi Trio]] - original, piano
- [[cal_tjader_trio|Cal Tjader Trio]]
- [[vince_guaraldi_sextet|Vince Guaraldi Sextet]] - piano
- [[cal_tjader_sextet|Cal Tjader Sextet]]
- [[cal_tjader_quartet|Cal Tjader Quartet]]
- [[the_cal_tjader_quintet|The Cal Tjader Quintet]]

## Musical Connections

### Mentors/Influences
- [[oscar_peterson|Oscar Peterson]] - Stylistic influence; Guaraldi was inspired by Peterson's jazz piano style during his formative years. (Influence evident in Guaraldi's trio recordings and improvisational approach.) [Late 1940s–1950s]
- [[bill_evans|Bill Evans]] - Stylistic influence; Guaraldi admired Evans's harmonic sophistication and lyricism. (Reflected in Guaraldi's melodic and harmonic choices.) [1950s]
- [[jimmy_yancey|Jimmy Yancey]] - Early blues and boogie-woogie inspiration for Guaraldi's piano playing. (Influence on Guaraldi's rhythmic drive.) [1940s]

### Key Collaborators
- [[cal_tjader|Cal Tjader]] - Band leader; Guaraldi was pianist in Tjader's ensembles, performing and recording extensively. (Multiple albums with Cal Tjader's groups in the 1950s.) [Early–late 1950s]
- [[bola_sete|Bola Sete]] - Frequent collaborator; Guaraldi and Sete recorded and performed together, blending jazz and bossa nova. (Albums: 'Vince Guaraldi, Bola Sete and Friends', 'From All Sides', 'Live at El Matador'.) [1963–1966]
- [[eddie_duran|Eddie Duran]] - Guitarist in the original Vince Guaraldi Trio. (Albums: 'The Vince Guaraldi Trio', 'A Flower is a Lovesome Thing'.) [Mid–late 1950s]
- [[dean_reilly|Dean Reilly]] - Bassist in the original Vince Guaraldi Trio. (Albums: 'The Vince Guaraldi Trio', 'A Flower is a Lovesome Thing'.) [Mid–late 1950s]
- [[woody_herman|Woody Herman]] - Guaraldi toured with Herman's 'Thundering Herd' big band, replacing Nat Pierce on piano. (Three albums with Herman's band (Guaraldi's contributions are less prominent).) [1956, 1959]

### Artists Influenced
- [[larry_vuckovich|Larry Vuckovich]] - Guaraldi's only known piano student; later became a respected jazz pianist. (Collaborated with Guaraldi in performances.) [Late 1950s–1976]
- [[david_benoit|David Benoit]] - Cited Guaraldi as a major influence, especially in his own 'Peanuts' music work. (Albums: 'Here's to You, Charlie Brown: 50 Great Years!') [1980s–present]
- [[george_winston|George Winston]] - Inspired by Guaraldi's melodic jazz style; recorded tribute albums. (Album: 'Linus & Lucy: The Music of Vince Guaraldi'.) [1990s]
