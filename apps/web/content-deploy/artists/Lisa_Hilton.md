...
audio_profile:
  ...
  instrumentalness_avg: 0.877
  loudness_avg: -18.2
  speechiness_avg: 0.036
  liveness_avg: 0.118
  track_count: 50
  computed_at: '2025-12-23T08:16:03.024121'
similar_artists: []
musical_connections:
  collaborators:
    - Antonio Sánchez
...
*Sources: [Source1](https://www.allaboutjazz.com/take-five-with-lisa-hilton-revisited), [Source2](https://www.lisahiltonmusic.com/my-story), [Source3](https://www.allaboutjazz.com/musicians/lisa-hilton/)*

*Source: [Wikipedia](https://en.wikipedia.org/wiki/Lisa_Hilton)*
...
### Top Tracks
1. See You Again (Lucky All Along)
2. Too Hot (American Impressions)
3. And Some Blues… (Lucky All Along)
4. Lucky All Along (Lucky All Along)
5. Hollywood Moment (Lucky All Along)
6. Simmer (Kaleidoscope)
7. Seduction (Day & Night)
8. Little Beach Mornings (Lucky All Along)
9. Escapist Fantasy (Lucky All Along)
10. All Blues (Lucky All Along)

## External Links
- [Spotify](https://open.spotify.com/artist/02TuGOMPygRh8f5AIDYD5C)
- [Wikipedia](https://en.wikipedia.org/wiki/Lisa_Hilton)- [MusicBrainz](https://musicbrainz.org/artist/e2af8c5b-c9ef-4df2-b598-5ed675841b51)
---
