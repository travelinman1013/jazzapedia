...
audio_profile:
  ...
  liveness_avg: 0.158
  track_count: 47
  computed_at: '2025-12-23T08:16:04.171610'
similar_artists: []
musical_connections:
  collaborators:
    - Freddie Hubbard
...
*Sources: [Source1](http://www.toddherbert.com/about.html), [Source2](https://www.paris-move.com/reviews/todd-herbert-captain-hubs/), [Source3](https://jazztimes.com/archives/todd-herbert-the-tree-of-life/), [Source4](https://www.allaboutjazz.com/the-path-to-infinity-todd-herbert-metropolitan-records-review-by-jerry-dsouza), [Source5](http://metropolitanrecordsnyc.com/catalog/tree-of-life/), [Source6](https://papatamusredux.com/2025/10/01/todd-herbert-captain-hubs/)*
...
### Mentors/Influences
- [[John_Coltrane|John Coltrane]] - Primary stylistic influence; Coltrane's music was introduced to Herbert by his saxophone teacher and became a foundational inspiration. ('Live at Birdland' (Coltrane album)) [Herbert's early teens onward]
...
### Top Tracks
1. Universal Freedom (Love Vibrations for Planet Earth)
2. Look into the Abyss (Running with Jazz)
3. Captain Hubs (Running with Jazz)
4. Do This (Running with Jazz)
5. Herbs of Healing (Running with Jazz)
6. Years of Dreaming (Ballads in Jazz)
7. Bright Moments - Alternate Mix (Ballads in Jazz)
8. You Just Never Know (Along the Path)
9. Place Picasso (Along the Path)
10. Universal Freedom (Along the Path)
