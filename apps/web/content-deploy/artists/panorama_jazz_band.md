...
genres: []
infobox:
  image: 03_Resources/source_material/ArtistPortraits/panorama_jazz_band.jpg
  caption: Panorama Jazz Band
...
audio_profile:
  ...
  liveness_avg: 0.207
  track_count: 52
  computed_at: '2025-12-23T08:16:13.909942'
similar_artists: []
musical_connections:
  collaborators:
    - Aurora Nealand
...
*Sources: [Source1](https://bittersoutherner.com/kosher-gumbo-panorama-brass-band), [Source2](https://www.myneworleans.com/panorama-jazz-band/), [Source3](https://www.myneworleans.com/ben-schenk-and-the-panorama-jazz-band/), [Source4](https://www.neworleans.com/listing/panorama-jazz-band/46512/)*
...
### Mentors/Influences
- [[dr._michael_white|Dr. Michael White]] - Schenck was inspired after seeing Dr. White perform at the Smithsonian Folk Life Festival, which influenced his move to New Orleans and his musical direction. (Collaborated on the arrangement of 'Tolú' for The Next One) [1985, ongoing influence]

### Key Collaborators
- [[aurora_nealand|Aurora Nealand]] - Joined as alto saxophonist, bringing a new improvisational dimension and connecting the band more firmly to a wider jazz context. (Featured on recordings and live performances since joining) [2005–present]
- [[charlie_halloran|Charlie Halloran]] - Main trombonist, contributing to both recordings and live performances. (Band member on multiple albums) [2000s–present]
- [[matt_perrine|Matt Perrine]] - Tuba player, integral to the band's sound and arrangements. (Band member on multiple albums) [2000s–present]
- [[walter_mcclements|Walter McClements]] - Accordionist, key to the band's unique blend of styles. (Band member on multiple albums) [2000s–present]
- [[sean_clark|Sean Clark]] - Drummer and steam whistle player, part of the core ensemble. (Band member on multiple albums) [2000s–present]

### Artists Influenced
- [[new_orleans_wedding_and_party_bands|New Orleans wedding and party bands]] - Panorama's eclectic, dance-oriented approach and world music repertoire have inspired a new generation of local bands to expand their stylistic boundaries. (Live performances, community events) [2000s–present]
