...
audio_profile:
  ...
  liveness_avg: 0.249
  track_count: 50
  computed_at: '2025-12-23T08:16:16.883797'
similar_artists: []
musical_connections:
  collaborators:
...
*Sources: [Source1](https://thejuniorleague.bandcamp.com), [Source2](https://www.myspiltmilk.com/articles/the-junior-league-counts-on-its-friends-at-jazz-fest), [Source3](https://thejuniorleague.bandcamp.com/album/live-at-blue-velvet)*
...
### Mentors/Influences
- [[the_beatles|The Beatles]] - Major stylistic influence; Adragna has cited their melodic sensibility and harmonies as foundational to his songwriting. (General influence across The Junior League's discography) [2000s–present]
- [[big_star|Big Star]] - Influence on power pop sound and production approach. (General influence, especially on albums like 'Smile Shoot Smile') [2000s–present]

### Key Collaborators
- [[various_new_orleans_musicians|Various New Orleans musicians]] - Contributed as guest performers on recordings and live shows. (Albums such as 'Also Rans', 'Eventually Is Now') [2000s–present]
...
### Top Tracks
1. Let's Hear It For The Dead (OUR BROADCAST DAY)
2. Everybody Knows (OUR BROADCAST DAY)
3. The Me and Them (OUR BROADCAST DAY)
4. 1973 Nervous Breakdown (OUR BROADCAST DAY)
5. Skinny Tie (Nattering Nabobs)
6. Also Rans (Also Rans)
7. A Dagger and a Kiss (Also Rans)
8. The Stars in Our Eyes (Also Rans)
9. Before You Go (Also Rans)
10. Please (I Need You To) (Also Rans)
