...
genres: []
infobox:
  image: 03_Resources/source_material/ArtistPortraits/smilin_myron.jpg
  caption: smilin myron
...
audio_profile:
  ...
  liveness_avg: 0.163
  track_count: 11
  computed_at: '2025-12-23T08:16:15.774780'
similar_artists: []
musical_connections:
  collaborators:
    - Tim Guarisco
...
*Sources: [Source1](https://www.offbeat.com/articles/smilin-myron-all-smiles/), [Source2](https://www.offbeat.com/articles/the-summer-funk-smilin-myron-loses-tim-guarisco-to-cancer/)*
...
### Key Collaborators
- [[tim_guarisco|Tim Guarisco]] - Core band member (guitarist, vocalist, songwriter) and key creative force within Smilin’ Myron (Live performances and original material with Smilin’ Myron in the New Orleans jam/funk scene) [From the band’s formation at Tulane University through his death (exact active years not specified)]
...
### Top Tracks
1. Johnny (What About The People?)
2. Tuna Ritz (What About The People?)
3. Horace Greedy (What About The People?)
4. The Marcsman (What About The People?)
5. The Ole Pecan Trail (What About The People?)
6. Bruff Lady (What About The People?)
7. The Mouse (What About The People?)
8. Everyday (What About The People?)
9. Apple Juice (What About The People?)
10. Business, This Is Tom (What About The People?)
