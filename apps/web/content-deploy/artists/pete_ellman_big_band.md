...
audio_profile:
  ...
  liveness_avg: 0.134
  track_count: 37
  computed_at: '2025-12-23T08:16:14.206402'
similar_artists: []
musical_connections:
  collaborators:
...
*Sources: [Source1](Neon Jazz interview with Big Band Leader Pete Ellman (YouTube transcript/interview)[1]), [Source2](Illinois Presenters Network – Pete Ellman Big Band NFP profile[2]), [Source3](Official Pete Ellman Big Band website[3]), [Source4](NCTV17 feature: “Pete Ellman Big Band bridges the gap for budding jazz musicians”[4]), [Source5](Midwest Clinic – Pete Ellman Big Band NFP performing organization profile[6])*
...
### Top Tracks
1. High Speed Pursuit (For Pete's Ache)
2. Livin' larger Than Life (For Pete's Ache)
3. When Lights Are Low (For Pete's Ache)
4. For Pete's Ache (For Pete's Ache)
5. Soon It's Gonna Rain (For Pete's Ache)
6. It Don't Mean a Thing (If It Ain't Got That Swing) (For Pete's Ache)
7. Manteca the "A" Train (For Pete's Ache)
8. Tenor Sanity (For Pete's Ache)
9. Dos Cinco Juan (For Pete's Ache)
10. Home, Sweet Home (For Pete's Ache)
