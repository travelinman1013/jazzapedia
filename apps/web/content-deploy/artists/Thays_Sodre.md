...
audio_profile:
  ...
  liveness_avg: 0.209
  track_count: 34
  computed_at: '2025-12-23T08:16:04.045578'
similar_artists: []
musical_connections:
  collaborators: []
  influenced: []
...
## Quick Info
- **Genres**: tecnobrega, forró tradicional
...
*Sources: [Source1](https://www.putumayo.com/thayssodr%C3%A9), [Source2](https://bahia.ws/en/historia-origem-evolucao-forro/)*
...
### Mentors/Influences
- [[luiz_gonzaga|Luiz Gonzaga]] - Influential figure in forró tradicional, whose music shaped the foundational sound of the genre that Sodré performs. (Classic forró recordings) [Referenced as inspiration throughout Sodré's career]
...
### Top Tracks
1. Confissão (Café Brazil by Putumayo)
2. Céu (Céu)
3. Confissão (Flor do Destino)
4. Baila do Lundu (Baila do Lundu)
5. Pérola Azulada (Pérola Azulada)
6. Tudo é Bom e Nada Presta (Flor do Destino)
7. Onde Está Você? (Onde Está Você?)
8. Sabor Açaí (Flor do Destino)
9. Não Vou Sair (Flor do Destino)
10. Seus Olhinhos (Seus Olhinhos)
