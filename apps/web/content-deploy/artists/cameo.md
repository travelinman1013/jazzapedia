...
audio_profile:
  ...
  liveness_avg: 0.16
  track_count: 50
  computed_at: '2025-12-23T08:16:06.319774'
similar_artists: []
musical_connections:
  collaborators:
    - Larry Blackmon
...
*Sources: [Source1](https://www.last.fm/music/Cameo/+wiki), [Source2](https://www.youtube.com/watch?v=5--mngagdgY), [Source3](https://blackpast.org/african-american-history/cameo-1974/)*
...
## Members
- [[william_seth_allen|William Seth Allen]]
- [[larry_blackmon|Larry Blackmon]]
- [[jeryl_bright|Jeryl Bright]]
- [[michael_burnett|Michael Burnett]] - bass guitar
- [[tomi_jenkins|Tomi Jenkins]]
- [[nathan_leftenant|Nathan Leftenant]]
- [[aaron_mills|Aaron Mills]]
- [[charlie_singleton|Charlie Singleton]]

## Musical Connections

### Mentors/Influences
- [[parliament-funkadelic|Parliament-Funkadelic]] - Cameo was heavily influenced by the horn-driven, theatrical funk style of Parliament-Funkadelic, especially in their early years. (Early albums like 'Cardiac Arrest' and 'We All Know Who We Are') [1970s]

### Key Collaborators
- [[larry_blackmon|Larry Blackmon]] - Founder, lead vocalist, and primary creative force; has remained the only constant member throughout the band's history. (All Cameo albums) [1974–present]
- [[nathan_leftenant|Nathan Leftenant]] - Original member and trumpeter, part of the group's core lineup during its classic period. (Key albums including 'Word Up!' and 'She's Strange') [1974–late 1980s]
- [[tomi_jenkins|Tomi Jenkins]] - Longtime vocalist and core member, contributing to the band's signature harmonies and stage presence. (Key albums including 'Word Up!' and 'She's Strange') [1974–present]
- [[aaron_mills|Aaron Mills]] - Joined as bassist in 1978, bringing a jazz-funk influence from his time with Donald Byrd's N.C.C.U. (Albums from 'Secret Omen' onward) [1978–present]
- [[charlie_singleton|Charlie Singleton]] - Guitarist and vocalist, contributed to the band's 1980s sound and later pursued a solo career while still collaborating with Cameo. ('Word Up!', 'She's Strange') [1982–late 1980s]

### Artists Influenced
- [[outkast|OutKast]] - Cameo's blend of funk and hip hop, as well as their Atlanta roots, influenced OutKast's approach to genre fusion. (OutKast's use of funk elements in albums like 'Speakerboxxx/The Love Below') [1990s–2000s]
- [[tlc|TLC]] - Cameo's rhythmic innovations and stage presence influenced TLC's performance style and sound. (TLC's 'CrazySexyCool' era) [1990s]
- [[numerous_hip_hop_artists|Numerous hip hop artists]] - Cameo's tracks, especially 'Word Up!' and 'Candy,' have been widely sampled in hip hop and R&B. (Samples in works by Tupac, Mariah Carey, and others) [1990s–present]
...
1. Word Up (Word Up)
2. Candy (Word Up)
3. Sparkle (Secret Omen)
4. Single Life (Anthology)
5. Candy
6. Funk Funk (Cardiac Arrest)
7. Attack Me With Your Love (Single Life)
8. Loverboy (Glitter)
9. She's Strange (She's Strange)
10. Back And Forth (Word Up)
