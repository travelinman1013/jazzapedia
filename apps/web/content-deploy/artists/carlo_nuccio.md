...
audio_profile:
  ...
  liveness_avg: 0.184
  track_count: 12
  computed_at: '2025-12-23T08:16:06.438719'
similar_artists: []
musical_connections:
  collaborators:
...
*Sources: [Source1](https://www.jonathanfreilich.com/music-interviews/2020/4/4/interview-with-new-orleans-drummer-carlo-nuccio), [Source2](https://www.offbeat.com/articles/in-memoriam-carlo-nuccio-1961-2022/), [Source3](https://www.dailykos.com/stories/2022/8/26/2119054/-Carlo-Nuccio-An-Appreciation)*
...
## Associated Acts
- [[continental_drifters|Continental Drifters]]

## Musical Connections

### Mentors/Influences
- [[earl_palmer|Earl Palmer]] - Influenced Nuccio's drumming style and approach to rhythm (General stylistic influence, not tied to specific recordings) [Formative years (1970s)]

### Key Collaborators
- [[continental_drifters|Continental Drifters]] - Band member and drummer (Albums and live performances with the band) [1990s–2000s]
- [[alex_mcmurray|Alex McMurray]] - Frequent collaborator in New Orleans music scene (Live performances and recordings) [2000s–2020s]
- [[john_mooney|John Mooney]] - Played drums in Mooney's band (Live performances) [2000s–2020s]
- [[benny_grunch|Benny Grunch]] - Collaborated as drummer (Live and studio work) [2000s–2020s]
- [[david_torkanowsky|David Torkanowsky]] - Collaborated in New Orleans music projects (Various performances) [1980s–2000s]

### Artists Influenced
- [[younger_new_orleans_drummers|Younger New Orleans drummers]] - Inspired by Nuccio's unique style and dedication to the fundamentals of drumming (General influence on the local scene) [1990s–2020s]
...
### Top Tracks
1. Smoke My Peace Pipe (feat. Carlo Nuccio) (Smoke My Peace Pipe (feat. Carlo Nuccio))
2. It's Happening Again (Clap Hands)
3. The Fall (Clap Hands)
4. Song in My Head (Clap Hands)
5. Planning the Fishing Trip (Clap Hands)
6. Long While (Clap Hands)
7. Denial (Clap Hands)
8. Subway Trains (Clap Hands)
9. I’ll Wait (Clap Hands)
10. Austin (Clap Hands)
