...
audio_profile:
  ...
  liveness_avg: 0.184
  track_count: 50
  computed_at: '2025-12-23T08:16:07.737368'
similar_artists: []
musical_connections:
  collaborators: []
  influenced: []
...
## Quick Info
- **Genres**: afropiano, afro adura, afrobeats, afrobeat
...
*Sources: [Source1](https://funky16corners.com/?p=850), [Source2](https://recentmusic.com/artist/7FQkKL5GaSvsWAuzMQjUut/)*
...
1. Ali (Ali)
2. Lost (Lost)
3. OLD TAKER (OLD TAKER)
4. Wise (Wise)
5. Wetin Go Be (Wetin Go Be)
6. Chant (Chant)
7. Prayer of Jabeze (Part 2) (Prayer of Jabeze)
8. Prayer (Prayer)
9. Hero (feat. Danni Da Ros) - Diamond Boy Remix Edit (90's Reloaded (Mixed by Samus Jay))
10. Super Bass (Diamond Boy Radio Mix)
