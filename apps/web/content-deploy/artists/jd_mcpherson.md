...
audio_profile:
  ...
  liveness_avg: 0.158
  track_count: 50
  computed_at: '2025-12-23T08:16:10.271763'
similar_artists: []
musical_connections:
  collaborators:
    - Jimmy Sutton
...
*Sources: [Source1](https://www.last.fm/music/JD+McPherson/+wiki), [Source2](https://www.highroadtouring.com/artists/jd-mcpherson/), [Source3](https://concord.com/publishing-roster/jd-mcpherson/), [Source4](https://www.redlightmanagement.com/artists/j-d-mcpherson/), [Source5](https://lightning100.com/localmusic/jd-mcpherson-just-around-the-corner-local-artist-of-the-week/)*

*Source: [Wikipedia](https://en.wikipedia.org/wiki/JD_McPherson)*
...
### Top Tracks
1. LUCKY PENNY (UNDIVIDED HEART & SOUL)
2. Sunshine Getaway (Nite Owls)
3. North Side Gal (Signs & Signifiers)
4. Head Over Heels (Let The Good Times Roll)
5. CRYING’S JUST A THING YOU DO (UNDIVIDED HEART & SOUL)
6. BLOODHOUND ROCK (UNDIVIDED HEART & SOUL)
7. Head Over Heels (Let The Good Times Roll)
8. A Gentle Awakening (Signs & Signifiers)
9. Sunshine Getaway
10. Let The Good Times Roll (Let The Good Times Roll)
