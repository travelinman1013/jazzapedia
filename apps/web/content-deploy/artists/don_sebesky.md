...
audio_profile:
  ...
  instrumentalness_avg: 0.294
  loudness_avg: -13.4
  speechiness_avg: 0.058
  liveness_avg: 0.176
  track_count: 50
  computed_at: '2025-12-23T08:16:07.909632'
similar_artists: []
musical_connections:
  collaborators:
    - Wes Montgomery
...
*Sources: [Source1](WRTI obituary and career overview[1]), [Source2](ROVR artist biography[2]), [Source3](KNKX remembrance feature[3]), [Source4](LeDor Publishing biography[4]), [Source5](All About Jazz profile on Don Sebesky[5]), [Source6](Manhattan School of Music planned giving profile[6]), [Source7](Living Jazz Archives – Don Sebesky Collection biography[7])*
...
### Mentors/Influences
- [[kai_winding|Kai Winding]] - Bandleader and senior trombonist whose group gave Sebesky early big‑band and small‑group experience, shaping his sense of trombone writing and ensemble texture. (Performances and recordings as trombonist in Kai Winding’s band (early career big‑band work).) [Late 1950s–early 1960s[5]]
- [[claude_thornhill|Claude Thornhill]] - Leader of a harmonically adventurous big band whose orchestrational approach and use of color provided an important model for Sebesky’s later large‑ensemble writing. (Touring and recording with the Claude Thornhill band as trombonist.) [Circa late 1950s[5]]
- [[maynard_ferguson|Maynard Ferguson]] - High‑energy big‑band leader whose modern charts and brass writing influenced Sebesky’s approach to contemporary, rhythmically driven orchestration. (Performances with the Maynard Ferguson orchestra as a trombonist.) [Late 1950s–early 1960s[5]]

### Key Collaborators
- [[wes_montgomery|Wes Montgomery]] - Sebesky served as primary arranger for Montgomery’s late‑1960s CTI recordings, helping craft the guitarist’s orchestral crossover sound. (Arrangements for CTI albums including projects such as "Bumpin'" and "Tequila" (widely cited CTI collaborations).) [Mid‑1960s[1][4]]
- [[george_benson|George Benson]] - Key collaborator at CTI; Sebesky’s arrangements framed Benson’s guitar and vocals in rich, contemporary orchestral settings that broadened Benson’s appeal. (Arranging and orchestrating on CTI releases for George Benson.) [Late 1960s–1970s[1][4]]
- [[freddie_hubbard|Freddie Hubbard]] - Collaborated as arranger on Hubbard’s CTI recordings, contributing to some of the most influential jazz‑fusion and crossover albums of the period. (Arrangements on CTI albums such as "First Light," which earned critical acclaim and awards.) [Early 1970s[1][4]]
- [[creed_taylor|Creed Taylor]] - Producer and founder of CTI Records; Taylor regularly hired Sebesky as house arranger, making him central to the label’s signature sound. (Extensive arranging work across CTI catalog, including projects for Montgomery, Benson, Hubbard and others.) [1960s–1970s[1][4]]
- [[carlos_santana|Carlos Santana]] - Sebesky was engaged by Santana for orchestral arranging, recognized by Santana as one of his favorite arrangers. (Orchestrations/arrangements for Santana projects (noted by Manhattan School of Music profile).) [1990s–2000s[6]]

### Artists Influenced
- [[contemporary_jazz_arrangers_and_orchestrators|Contemporary jazz arrangers and orchestrators]] - Sebesky’s CTI work and large‑ensemble albums became reference points for later jazz and crossover arrangers seeking to blend jazz harmony with pop, classical, and cinematic elements. (Influence traceable to albums such as "Giant Box" and his orchestrations for "Kiss Me, Kate," which are studied and emulated in arranging programs.) [1980s onward (ongoing influence)[1][3][4]]
...
### Top Tracks
1. Snowfall (Let's Share Christmas)
2. When I'm 64 (John Pizzarelli Meets The Beatles)
3. Yesterday's Dreams (First Light (CTI Records 40th Anniversary Edition))
4. The Rite Of Spring (Three Works For Jazz Soloists & Symphony Orchestra)
5. Things We Said Today (John Pizzarelli Meets The Beatles)
6. Get Back (John Pizzarelli Meets The Beatles)
7. You've Got To Hide Your Love Away (John Pizzarelli Meets The Beatles)
8. Oh Darling (John Pizzarelli Meets The Beatles)
9. For No One (John Pizzarelli Meets The Beatles)
10. (I've Got A Gal In) Kalamazoo (Our Love Is Here To Stay)
