...
audio_profile:
  ...
  liveness_avg: 0.25
  track_count: 82
  computed_at: '2025-12-23T08:16:01.021828'
similar_artists: []
musical_connections:
  collaborators:
    - Marc Savoy
...
## Quick Info
- **Genres**: cajun, zydeco
- **Born**: 1952-01-20 in Richmond
- **Occupation**: historian, singer, music historian
- **Instruments**: voice
- **Years Active**: 1980–present
- **Record Labels**: Vanguard Records
- **Spouse**: Marc Savoy
...
*Sources: [Source1](Smithsonian Folkways Recordings), [Source2](Wikipedia), [Source3](Arhoolie Foundation)*

*Source: [Wikipedia](https://en.wikipedia.org/wiki/Ann_Savoy)*
