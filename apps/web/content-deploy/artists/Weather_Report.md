...
audio_profile:
  ...
  liveness_avg: 0.218
  track_count: 50
  computed_at: '2025-12-23T08:16:04.273433'
similar_artists: []
musical_connections:
  collaborators:
    - Joe Zawinul
...
## Quick Info
- **Genres**: jazz fusion, jazz, jazz funk, free jazz
...
*Sources: [Source1](https://weatherreportband.com/the-band/), [Source2](https://www.weatherreportdiscography.org/elegant-people-a-history-of-the-band-weather-report/), [Source3](https://www.britannica.com/topic/Weather-Report), [Source4](https://jazzfuel.com/weather-report-band/)*
...
### Top Tracks
1. Birdland (Heavy Weather)
2. A Remark You Made (Heavy Weather)
3. Teen Town (Heavy Weather)
4. Teen Town (Heavy Weather (Expanded Edition))
5. Palladium (Heavy Weather)
6. Black Market (Black Market)
7. Harlequin (Heavy Weather)
8. Havona (Heavy Weather)
9. Cucumber Slumber (Mysterious Traveller)
10. Havona (Heavy Weather (Expanded Edition))
