...
audio_profile:
  ...
  liveness_avg: 0.201
  track_count: 102
  computed_at: '2025-12-23T08:16:08.764367'
similar_artists: []
musical_connections:
  collaborators:
    - Harry James
...
## Quick Info
- **Genres**: christmas, big band, adult standards, swing music, jazz
...
*Sources: [Source1](https://historycooperative.org/frank-sinatra-bio/), [Source2](https://www.ebsco.com/research-starters/history/frank-sinatra), [Source3](https://study.com/academy/lesson/frank-sinatra-biography-quotes.html), [Source4](https://www.rickblessing.com/frank-sinatra-trivia/frank-sinatra-chronoligical-biography/), [Source5](https://www.biography.com/musicians/frank-sinatra)*
...
### Mentors/Influences
- [[bing_crosby|Bing Crosby]] - Sinatra was influenced by Crosby's easy-listening vocal style and phrasing, which shaped his own approach to singing. (Sinatra often cited Crosby as a primary inspiration in interviews and emulated his style in early recordings.) [1930s-1940s]
- [[tommy_dorsey|Tommy Dorsey]] - As bandleader and trombonist, Dorsey taught Sinatra breath control and phrasing, critical to Sinatra's signature style. (Collaborated on hits like 'I'll Never Smile Again' and 'Stardust' with the Tommy Dorsey Orchestra.) [1940-1942]

### Key Collaborators
- [[harry_james|Harry James]] - Sinatra's first major bandleader; gave Sinatra his initial professional recording opportunity. (Recorded 'All or Nothing at All' and other early singles with the Harry James Orchestra.) [1939-1940]
- [[nelson_riddle|Nelson Riddle]] - Arranger and conductor; shaped Sinatra’s sound during the Capitol Records era. (Arranged albums like 'In the Wee Small Hours' and 'Songs for Swingin' Lovers!') [1953-1962]
- [[count_basie|Count Basie]] - Jazz bandleader; collaborated on swinging big band albums. ('Sinatra-Basie: An Historic Musical First' and 'It Might as Well Be Swing') [1962-1964]
- [[antonio_carlos_jobim|Antonio Carlos Jobim]] - Brazilian composer; partnered with Sinatra for bossa nova recordings. ('Francis Albert Sinatra & Antonio Carlos Jobim') [1967]
- [[gene_kelly|Gene Kelly]] - Co-starred in several MGM musicals, blending singing and dancing. ('Anchors Aweigh', 'On the Town', 'Take Me Out to the Ball Game') [1945-1949]

### Artists Influenced
- [[tony_bennett|Tony Bennett]] - Bennett cited Sinatra as a major influence on his phrasing and approach to standards. (Bennett’s interpretations of the Great American Songbook reflect Sinatra’s influence.) [1950s-present]
- [[michael_bublé|Michael Bublé]] - Bublé’s vocal jazz and swing style is directly inspired by Sinatra’s recordings and stage persona. (Albums such as 'It's Time' and 'Call Me Irresponsible' pay homage to Sinatra.) [2000s-present]
- [[harry_connick_jr|Harry Connick Jr.]] - Connick’s jazz vocals and big band arrangements are modeled after Sinatra’s Capitol and Reprise eras. (Connick’s albums and performances often reference Sinatra’s repertoire.) [1990s-present]
