...
audio_profile:
  ...
  instrumentalness_avg: 0.48
  loudness_avg: -12.7
  speechiness_avg: 0.054
  liveness_avg: 0.309
  track_count: 21
  computed_at: '2025-12-23T08:16:03.303106'
similar_artists: []
musical_connections:
  collaborators:
    - Bryan Webre
...
*Sources: [Source1](stringsmagazine.com), [Source2](rockandrollglobe.com), [Source3](antigravitymagazine.com)*

*Source: [Wikipedia](https://en.wikipedia.org/wiki/Cajun_accordion)*
...
### Top Tracks
1. Dans les pins (Blood Moon)
2. Two-Step de Ste. Marie (TINY ISLAND)
3. Ma jolie petite fille (Cosmic Cajuns from Saturn)
4. Latibonit (TINY ISLAND)
5. Blues de Neg Francais (TINY ISLAND)
6. Bluerunner / La Lune Est Croche (TINY ISLAND)
7. Two-Step de ste Marie (Blood Moon)
8. Grand marais (Blood Moon)
9. Blues de neg Francais (Blood Moon)
10. La lune est croche (Blood Moon)

## External Links
- [Spotify](https://open.spotify.com/artist/3rEhYm8Jp63lEzwL0uKjNo)
- [Wikipedia](https://en.wikipedia.org/wiki/Cajun_accordion)- [MusicBrainz](https://musicbrainz.org/artist/d7793fc8-fa3e-4592-a9ea-e01c9d148d04)
