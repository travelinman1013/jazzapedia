---
title: David Murray / James Newton Quintet
wiki_slug: david-murray-james-newton-quintet
schema_version: 2
status: active
aliases: []
...
audio_profile:
  ...
  liveness_avg: 0.16
  track_count: 7
  computed_at: '2025-12-23T08:16:01.690974'
similar_artists: []
musical_connections:
  collaborators:
    - James Newton
...
- **Born**: 1953-05-01 in Los Angeles
- **Occupation**: composer, conductor, jazz musician
- **Instruments**: flute
- **Years Active**: 1978–present
- **Record Labels**: Blue Note, ECM Records
...
*Sources: [Source1](musicianguide.com), [Source2](Wikipedia), [Source3](JazzTimes)*

*Source: [Wikipedia](https://en.wikipedia.org/wiki/James_Newton)*

### Top Tracks
1. Muhammad Ali (David Murray / James Newton Quintet)
2. Valerie (David Murray / James Newton Quintet)
3. Moon Over Sand II (David Murray / James Newton Quintet)
4. Inbertwinxt (David Murray / James Newton Quintet)
5. Doni's Song (David Murray / James Newton Quintet)
6. Blues in the Pocket (David Murray / James Newton Quintet)
7. Akhenaten (David Murray / James Newton Quintet)

## Discography

### Top Tracks
1. Valerie (David Murray / James Newton Quintet)
2. Moon Over Sand II (David Murray / James Newton Quintet)
3. Muhammad Ali (David Murray / James Newton Quintet)
4. Inbertwinxt (David Murray / James Newton Quintet)
5. Akhenaten (David Murray / James Newton Quintet)
6. Blues in the Pocket (David Murray / James Newton Quintet)
7. Doni's Song (David Murray / James Newton Quintet)

## External Links
- [Spotify](https://open.spotify.com/artist/13ClFXTkv4THIL7i5ex3H2)
- [Wikipedia](https://en.wikipedia.org/wiki/James_Newton)
