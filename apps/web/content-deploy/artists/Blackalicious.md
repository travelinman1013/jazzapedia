...
audio_profile:
  ...
  liveness_avg: 0.249
  track_count: 50
  computed_at: '2025-12-23T08:16:01.244431'
similar_artists: []
musical_connections:
  collaborators:
    - DJ Shadow
...
*Sources: [Source1](https://www.hollywoodbowl.com/musicdb/artists/681/blackalicious), [Source2](https://hiphopgoldenage.com/artists/blackalicious/)*
...
### Mentors/Influences
- [[DJ_Shadow|DJ Shadow]] - Influential collaborator and member of Solesides/Quannum Projects (Endtroducing…..) [1990s]

### Key Collaborators
- [[DJ_Shadow|DJ Shadow]] - Collaboration on early works like 'Count and Estimate' (SoleSides label releases) [1992]
- [[Lateef_the_Truthspeaker|Lateef the Truthspeaker]] - Member of Solesides/Quannum Projects and frequent collaborator (Maroons' Ambush) [1990s-2000s]
- [[Lyrics_Born|Lyrics Born]] - Member of Solesides/Quannum Projects (Various Quannum Projects releases) [1990s-2000s]

### Artists Influenced
- [[Underground_hip-hop_artists|Underground hip-hop artists]] - Inspiration through their unique lyrical style and production (General influence on underground hip-hop) [Late 1990s-present]
...
### Top Tracks
1. Make You Feel That Way (Blazing Arrow)
2. Alphabet Aerobics
3. Callin' Out (Callin' out 12")
4. Deception (Nia)
5. Blazing Arrow (Blazing Arrow)
6. Swan Lake
7. Shallow Days (Nia)
8. Sky Is Falling (Blazing Arrow)
9. First In Flight (Blazing Arrow)
10. Paragraph President (Blazing Arrow)
