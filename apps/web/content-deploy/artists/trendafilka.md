...
genres: []
infobox:
  image: 03_Resources/source_material/ArtistPortraits/trendafilka.jpg
  caption: TRENDAFILKA
...
audio_profile:
  ...
  liveness_avg: 0.18
  track_count: 22
  computed_at: '2025-12-23T08:16:17.687714'
similar_artists: []
musical_connections:
  collaborators:
...
*Sources: [Source1](Official site: trendafilka.com (about page and member bios)[1]), [Source2](World Music Central feature on *For the Olives*[2]), [Source3](Trendafilka EPK (electronic press kit)[3]), [Source4](New Marigny Theatre event description[4]), [Source5](ANTIGRAVITY Magazine review of *Under, Over*[5]), [Source6](A Green Man Review article on *For the Olives*[6])*
...
### Key Collaborators
- [[misha_kachkachishvili|Misha Kachkachishvili]] - Two-time Grammy-winning producer of Trendafilka’s album *For the Olives* (*For the Olives* (Trendafilka, 2024)) [Around 2024 album production[2]]
- [[new_orleans_jazz_and_heritage_foundation|New Orleans Jazz & Heritage Foundation]] - Institutional supporter helping fund production of *For the Olives* (Funding support for *For the Olives*) [Pre-release period leading up to November 22, 2024[2]]
- [[threadhead_cultural_foundation|Threadhead Cultural Foundation]] - Funding partner contributing to the album’s realization (Support for *For the Olives*) [Pre-release period leading up to November 22, 2024[2]]
