...
audio_profile:
  ...
  liveness_avg: 0.141
  track_count: 49
  computed_at: '2025-12-23T08:16:05.820070'
similar_artists: []
musical_connections:
  collaborators:
...
*Sources: [Source1](https://www.bobmcalpine.ca), [Source2](https://www.last.fm/music/Bob+McAlpine/+wiki), [Source3](https://totallyguitars.com/packages/225-bob-mc-alpine-classic-rock-solo-fingerstyle-arrangements), [Source4](https://www.zoominfo.com/c/bob-mcalpine/371930093), [Source5](https://www.youtube.com/watch?v=LthmqZvTnlU)*
...
### Key Collaborators
- [[steely_dan_tribute_band_toronto-based|Steely Dan tribute band (Toronto-based)]] - Lead/utility guitarist in a Steely Dan tribute ensemble, performing detailed transcriptions and interpretations of the band’s catalog in clubs, theaters, and concert settings. (Live performances of Steely Dan repertoire with a tribute band in the Toronto area.) [Active for many years up to at least the mid‑2010s[1][4][5]]
- [[chicago_tribute_band_toronto-based|Chicago tribute band (Toronto-based)]] - Guitarist in a Chicago tribute band, covering Terry Kath and later-era Chicago guitar parts in horn‑band arrangements. (Live shows performing Chicago’s classic rock and horn‑rock material.) [Active for many years up to at least the mid‑2010s[1][4][5]]
...
### Top Tracks
1. ceilings (five seconds flat)
2. Spring Into Summer (Older (and Wiser))
3. doomsday (five seconds flat)
4. Call Your Mom (with Lizzy McAlpine) (Stick Season (Forever))
5. Pushing It Down and Praying (Older (and Wiser))
6. hate to be lame (five seconds flat)
7. Pushing It Down and Praying
8. reckless driving (five seconds flat)
9. Staying (Older)
10. To the Mountains (Give Me A Minute)
