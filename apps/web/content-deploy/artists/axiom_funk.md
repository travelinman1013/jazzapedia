...
audio_profile:
  ...
  liveness_avg: 0.211
  track_count: 16
  computed_at: '2025-12-23T08:16:05.022206'
similar_artists: []
musical_connections:
  collaborators:
    - Eddie Hazel
...
- **Record Labels**: Westbound Records
- **Associated Acts**: Funkadelic's albums in chronological order
...
*Sources: [Source1](http://music.hyperreal.org/labels/axiom/axibook1.html), [Source2](http://music.hyperreal.org/labels/axiom/axibook2.html), [Source3](https://daily.bandcamp.com/lists/bill-laswell-axiom-list)*

*Source: [Wikipedia](https://en.wikipedia.org/wiki/Cosmic_Slop)*
...
### Top Tracks
1. If 6 Was 9 (Funkcronomicon)
2. Pray My Soul (Funkcronomicon)
3. Under The Influence (Jes Grew) (Funkcronomicon)
4. Cosmic Slop (Funkcronomicon)
5. Order Within The Universe (Funkcronomicon)
6. Orbitron Attack (Funkcronomicon)
7. Hideous Mutant Freaks (Funkcronomicon)
8. Sax Machine (Funkcronomicon)
9. Free-Bass (Godzillartron Cush) (Funkcronomicon)
10. Tell The World (Funkcronomicon)

## External Links
- [Spotify](https://open.spotify.com/artist/7BaZ6eyG6duh3m6sfKIoe7)
- [Wikipedia](https://en.wikipedia.org/wiki/Cosmic_Slop)- [MusicBrainz](https://musicbrainz.org/artist/975c829a-644d-4fd0-9843-043428f4ee1e)
---
**Tags**: #funk, #soul
