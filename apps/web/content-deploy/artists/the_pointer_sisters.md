...
audio_profile:
  ...
  liveness_avg: 0.251
  track_count: 50
  computed_at: '2025-12-23T08:16:17.066600'
similar_artists: []
musical_connections:
  collaborators:
    - Richard Perry
...
*Sources: [Source1](https://www.averyspecialchristmas.org/artists/the-pointer-sisters), [Source2](https://thepointersisters.com/group-bio-short.html), [Source3](https://www.britannica.com/topic/the-Pointer-Sisters), [Source4](https://walkoffame.com/the-pointer-sisters/)*
...
## Members
- [[bonnie_pointer|Bonnie Pointer]] - original (from 1969 until 1977)
- [[june_pointer|June Pointer]] - original (from 1969 until 2000)
- [[anita_pointer|Anita Pointer]] (from 1969 until 2022)
- [[ruth_pointer|Ruth Pointer]] (from 1972-12)
- [[issa_pointer|Issa Pointer]] (from 2002 until 2009)
- [[sadako_pointer|Sadako Pointer]] (from 2009)
- [[jeff_breeh|Jeff Breeh]]

### Original Members
- [[ruth_pointer|Ruth Pointer]]
- [[sadako_pointer|Sadako Pointer]]

## Musical Connections

### Mentors/Influences
- [[reverend_elton_pointer|Reverend Elton Pointer]] - Father and early musical mentor, provided gospel training in church (Church of God in West Oakland performances) [1950s-1960s]

### Key Collaborators
- [[richard_perry|Richard Perry]] - Producer who helped shape their sound during their commercial peak (Energy, Special Things, Break Out) [Late 1970s-1980s]
- [[bonnie_pointer|Bonnie Pointer]] - Original member and co-writer before solo career (Early albums, 'Fairytale') [1969-1977]
- [[ruth_pointers_daughter_issa_and_granddaughter_sadako|Ruth Pointer's daughter Issa and granddaughter Sadako]] - Joined as performing members in later years (Live performances and tours) [2000s-present]

### Artists Influenced
- [[en_vogue|En Vogue]] - Inspired by The Pointer Sisters' harmonies and genre-crossing style (En Vogue's vocal arrangements and stage presence) [1990s-present]
- [[beyoncé|Beyoncé]] - Cited The Pointer Sisters as an influence on her performance style and vocal versatility (Live performances, genre-blending albums) [2000s-present]
...
### Top Tracks
1. I'm So Excited (So Excited! (Expanded Edition))
2. Jump (Original Mix) (Break Out (1983 Version - Expanded Edition))
3. I'm So Excited
4. Jump (For My Love) (Break Out)
5. Slow Hand (Black & White (Expanded Edition))
6. Fire (Energy (Expanded Edition))
7. I'm So Excited
8. Automatic (Break Out (1983 Version - Expanded Edition))
9. He's so Shy (Special Things (Bonus Track Version))
10. Jump (For My Love) (Break Out)
